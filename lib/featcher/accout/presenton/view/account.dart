        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                editbuttom(
                    nameaction: "Show card",
                    onPressed: () {
                      showDialog(
                          context: context, builder: (builder) => card());
                    }),
            ...
            const chaneges(
                image: "Asset/image/ooui_lock.png", text: "change password"),
            const chaneges(
                image: "Asset/image/email.png", text: "change email"),
            SizedBox(
              height: 50,
            ),
          ],
...
class editbuttom extends StatelessWidget {
  const editbuttom(
      {super.key, required this.nameaction, required this.onPressed});
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      child: Text(
        "log ouT",
        style: GoogleFonts.poppins(
            fontSize: 17, fontWeight: FontWeight.bold, color: maincolore),
      ),
    );
  }
}
