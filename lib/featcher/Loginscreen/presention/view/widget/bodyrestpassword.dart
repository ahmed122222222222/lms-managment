...
class BodyRestPass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   return Padding(
     ...
     child: ListView(
      children:  [
        const Text("enter code",style: Styels.font36,),
        Text("enter otp code from 4 ",style: Styels.fontw20,),
        Text("number",style: Styels.fontw20,),
        const SizedBox(height:90,),
        const OptVildation(),
        const SizedBox(height: 38,),
           CutamMainButtom(onPressed: (){}, nameaction: 'next',),
