...
class Cleander extends StatefulWidget {  @override
    ...
    return SafeArea(
      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            decoration: BoxDecoration(border: Border(bottom: BorderSide(color: Color(0xffB1B1B1)))),
            height: 100,
            child: Row(
         ...
         Expanded(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context,index)=>Padding(
              ...
              child: event(color1: mcolor[index], color2: scolor[index]),
            )))
      ],
      ),
    );
