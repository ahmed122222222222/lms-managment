...
class BodyMatrier extends StatelessWidget { 
    List colorsss =[const Color(0xffD1FAE5),const Color(0xffFAE8FF),const Color(0xfffD9E9FE),const Color(0xffFDE2F1)];
        ...
        children: [
          Padding(
            ...
            child: ListTile(
              ...
              title: Text("Parallel Programming",style: GoogleFonts.poppins(fontSize: 15,fontWeight: FontWeight.bold)),
              subtitle:Text("Dr : Amr Masoud",style: GoogleFonts.poppins(fontSize: 10,fontWeight: FontWeight.w500),), 
            ),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context,index)=>Padding(
                ...
                child: ItemLIs(color:colorsss[index], sttr: title[index], onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (builder)=>nav[index])); } ,),
              )),
          )
        ],
      );
