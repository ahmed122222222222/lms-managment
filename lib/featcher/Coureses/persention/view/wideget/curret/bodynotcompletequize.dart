            ...
            [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("From",style: GoogleFonts.poppins(fontSize: 20,fontWeight: FontWeight.normal),),
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text("10:00",style: GoogleFonts.poppins(fontSize:16 ,color: maincolore,fontWeight:FontWeight.normal),),
                      ),
                    ),
                    Text("to",style: GoogleFonts.poppins(fontSize: 20,fontWeight: FontWeight.normal),),
                     Container(
                      decoration: BoxDecoration(
              ...
              ,Startbutttom(nameaction: "start", onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (builder)=>Quetion())); },)
            ],
          );
  }
}